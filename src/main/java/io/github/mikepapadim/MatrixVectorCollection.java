...
public class MatrixVectorCollection {
     ...
     * Performs matrix multiplication between the weight matrix (W) and the input
     * vector (x). It uses the @Parallel annotation of TornadoVM to signify to the
     * compiler that the loop is data parallel. The weight matrix w and the input
     * vector x are TornadoVM {@link VectorFloat16} vectors, and reside off-heap.
     *
     * @param xout
     *            The output vector of the matrix multiplication.
     * @param x
     *            The input vector to be multiplied with the weight matrix,
     *            represented as a {@link VectorFloat16}.
     * @param w
     *            The weight matrix represented as a {@link VectorFloat16}.
     * @param n
     *            The number of columns in the weight matrix and the size of the
     *            input vector.
     * @param d
     ...
     * vector (x). It uses the @Parallel annotation of TornadoVM to signify to the
     * compiler that the loop is data parallel. The weight matrix w and the input
     * vector x are TornadoVM {@link VectorFloat8} vectors, and reside off-heap.
     *
     * @param xout
     *            The output vector of the matrix multiplication.
     * @param x
     *            The input vector to be multiplied with the weight matrix,
     *            represented as a {@link VectorFloat8}.
     * @param w
     *            The weight matrix represented as a {@link VectorFloat8}.
     * @param n
     *            The number of columns in the weight matrix and the size of the
     *            input vector.
     * @param d
     ...
     * vector (x). It uses the @Parallel annotation of TornadoVM to signify to the
     * compiler that the loop is data parallel. The weight matrix w and the input
     * vector x are TornadoVM {@link VectorFloat4} vectors, and reside off-heap.
     *
     * @param xout
     *            The output vector of the matrix multiplication.
     * @param x
     *            The input vector to be multiplied with the weight matrix,
     *            represented as a {@link VectorFloat4}.
     * @param w
     *            The weight matrix represented as a {@link VectorFloat4}.
     * @param n
     *            The number of columns in the weight matrix and the size of the
     *            input vector.
     * @param d
